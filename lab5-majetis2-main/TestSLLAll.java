...
public class TestSLLAll {
	...
	public void testSLLSetIntArray2() {
        ...
        int[] arr = {12, 2, -3, 10, 9}; // this list      
        
        SLLSet listObj2 = new SLLSet(arr);
        String expectedSet = "12, 2, -3, 10, 9";
        int expectedSize = 5;
        assertEquals(expectedSize,listObj2.getSize());
        assertEquals(expectedSet,listObj2.toString());
	}
	...
	public void testCopy2() {
        ...
        int[] arr = {-7, -1, 12, 53, 88}; // this list       
        SLLSet listObj2 = new SLLSet(arr);
		SLLSet copied = listObj2.copy();
        copied.add(-99);
        String expectedObj2 = "-7, -1, 12, 53, 88";
        String expectedCopied = "-99, -7, -1, 12, 53, 88";
        int expectedObj2Size = 5;
        int expectedCopiedSize = 6;
	...
	public void testAdd5() {
        ...
        int addfirst_neg = -77;  // test add
        
        String expectedObj2 = "-77, 1, 2, 3, 7, 8";
        int expectedObj2Size = 6;

        listObj2.add(addfirst_neg);
        assertEquals(expectedObj2Size,listObj2.getSize());
        assertEquals(expectedObj2,listObj2.toString());
	...
	public void testRemove5() {
        ...
        int[] arr = {-11, 2, 3, 7, 8}; // this list       
        SLLSet listObj2 = new SLLSet(arr);
        
        int removefirst_neg = -11;  // test remove
        
        //test remove

        listObj2.remove(removefirst_neg);
	...
	public void testUnion5() { 
        ...
        SLLSet listObj10 = listObj9.union(listObj9);
	...
	public void testUnion6() {
        ...
        int[] arr = {1, 2, 3, 7, 8}; // this list       
        SLLSet listObj2 = new SLLSet(arr);       
        int[] uni2 = {-1, 0, 1, 2, 3}; // for testing union
        SLLSet listObj7 = new SLLSet(uni2);
        SLLSet listObj8 = listObj2.union(listObj7);
        
        String expected = "-1, 0, 1, 2, 3, 7, 8";
        int expectedSize = 7;
	...
	public void testIntersection5() {
        ...
        int[] arr = {1, 2, 3, 7, 8}; // this list
        int[] inter3 = {-10, 7, 10, 100}; //test intersection
