...
//=================Question 2================================
    ...
    void TestQ2_true_zero(CuTest *tc) {
...
//=================Question 7================================  
    ...
    void TestQ7a_negzero(CuTest *tc) {
                int input = -1000000;
                int actual = Q7a(input);
                int expected = -1;
                CuAssertIntEquals(tc, expected, actual);
    ...
    void TestQ7b_2neg(CuTest *tc) {
            int input = -123456789;
            int actual = Q7b(input);
            int expected = -987654321;
            CuAssertIntEquals(tc, expected, actual);
    }
    void TestQ7b_zero(CuTest *tc) {
            int input = 0;
            int actual = Q7b(input);
            int expected = 0;
            CuAssertIntEquals(tc, expected, actual);
    ...
    CuSuite* Lab1GetSuite() {
        ...
        SUITE_ADD_TEST(suite, TestQ2_true_zero);
        ...
        SUITE_ADD_TEST(suite,TestQ4_invalid);
        ...
        SUITE_ADD_TEST(suite, TestQ7a_negzero);
        SUITE_ADD_TEST(suite, TestQ7b_1);
        SUITE_ADD_TEST(suite, TestQ7b_2);
        SUITE_ADD_TEST(suite, TestQ7b_2neg);
        SUITE_ADD_TEST(suite, TestQ7b_zero);
