...
//=========Question 1==================================
	...
	void TestQ1_space_empty(CuTest *tc) {
...
//=================Question 2================================
	...
	void TestQ2_student_Delete(CuTest *tc) {
	...
	void TestQ2_nostudent_Delete(CuTest *tc) {
	...
	void TestQ2_Delete_all(CuTest *tc) {
					char inputFile[] =  "students.txt";
					int size;
					//create list using the input file
					student **Clist = create_class_list(inputFile,&size);
...
//=================Question 3================================  
	...
	void TestQ3_compareStrings_zero(CuTest *tc) {

				char string_1[] = "apple";
				char string_2[] = "apples";
				int expected = 0;
				int actual = compare_str(string_1,string_2);

				CuAssertIntEquals(tc, expected, actual);

	}

	void TestQ3_compareStrings_one(CuTest *tc) {

					char string_1[] = "bananas";
					char string_2[] = "banana";
					int expected = 1;
					int actual = compare_str(string_1,string_2);
...
//===========================================================
	CuSuite* Lab3GetSuite() {
		...
		SUITE_ADD_TEST(suite, TestQ1_space_empty);
		...
		SUITE_ADD_TEST(suite, TestQ2_student_Delete);
		SUITE_ADD_TEST(suite, TestQ2_nostudent_Delete);
		SUITE_ADD_TEST(suite, TestQ2_Delete_all);


		SUITE_ADD_TEST(suite, TestQ3_readandSort1);
		SUITE_ADD_TEST(suite, TestQ3_readandSort2);
		SUITE_ADD_TEST(suite, TestQ3_compareStrings_zero);
		SUITE_ADD_TEST(suite, TestQ3_compareStrings_one);
